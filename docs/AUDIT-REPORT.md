...
> **NOT run:** live Lighthouse, real-device/browser matrix, runtime profiling. Such findings are labeled *Likely / Possible*, never *Verified*.
...
| Performance | 70 / 100 | *Likely* heavy (GSAP+Framer+Lenis+canvas); not measured |
