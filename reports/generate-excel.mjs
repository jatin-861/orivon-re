...
const WEBSITE = [
  ...
  ["Booking Website — Multi-service/Multi-staff","Healthcare, Hospitality","Medium","₹1.2L–₹2.8L",5,7],
...
const MOBILE = [
  ...
  ["Cross-Platform Business App (Flutter/RN)","Retail, Services, Startups","Medium","₹2.5L–₹6L",8,12],
  ["Cross-Platform Enterprise App","Enterprise, Logistics, Healthcare","High","₹6L–₹14L",12,18],
  ["Native Android App","Consumer, Fintech","Medium","₹3L–₹7L",8,12],
  ["Native iOS App","Consumer, Fintech, Premium Brands","Medium","₹3.5L–₹8L",8,13],
  ["Native Android + iOS (Complex/Enterprise)","Enterprise, Fintech, Healthcare","Enterprise","₹10L–₹25L",16,24],
  ["App + Custom Backend/API (full-stack mobile)","All Businesses","High","₹5L–₹12L",10,16],
  ["Marketplace / On-demand App (multi-sided)","Logistics, Services, Delivery","Enterprise","₹10L–₹22L",16,24],
];
...
const AUTOMATION = [
  ...
  ["AI Multi-channel Chatbot (Web+WhatsApp+IG)","Retail, D2C, Support-heavy","High","₹5L–₹15L",8,12],
  ...
  ["Internal Workflow Automation — Multi-tool Orchestration","All Businesses","Medium","₹2L–₹5L",4,7],
  ...
  ["AI Agent — Multi-step Agentic Workflow Platform","Enterprise, SaaS","Enterprise","₹8L–₹25L",12,18],
  ["Document / Invoice OCR Automation","Finance, Logistics, Legal","Medium","₹2L–₹5L",5,7],
  ["Compliance Document Auto-Generation","Legal, Manufacturing, Healthcare","Medium","₹2.5L–₹6L",6,8],
  ...
  ["Lead Capture & Auto-Routing Automation","Sales, Real Estate, D2C","Medium","₹1.5L–₹4L",4,6],
  ["Web Scraping / Data Pipeline Automation","Research, E-commerce, Finance","Medium","₹2L–₹5L",4,7],
...
const SAAS = [
  ...
  ["Finance, Billing & Compliance",[
    ...
    ["Multi-currency / Global Invoicing Platform","Export, Agencies, SaaS","Medium","₹3L–₹9L",6,10],
  ...
  ["HR & People Ops",[
    ...
    ["Time Tracking & Billing (Agency/Freelance)","Agencies, Consulting, Legal","Medium","₹2.5L–₹7L",5,8],
  ]],
  ["Operations, Assets & Workflow",[
    ...
    ["Procurement / e-Tendering Platform","Manufacturing, Govt-adjacent","High","₹6L–₹16L",10,14],
    ...
    ["Helpdesk & Ticketing System","Support Teams, SaaS, Enterprise","Medium","₹3L–₹10L",5,8],
  ...
  ["Education",[
    ...
    ["LMS – Learning Management System","EdTech, Enterprise Training","High","₹5L–₹15L",9,13],
  ...
  ["Healthcare",[
    ...
    ["Laboratory Information Mgmt System (LIMS)","Healthcare, Diagnostics","High","₹6L–₹18L",10,15],
  ...
  ["Logistics, Fleet & Field Ops",[
    ...
    ["Warehouse Management System","Retail, Manufacturing, Logistics","Medium","₹5L–₹15L",8,12],
    ["Field Service Management","Utilities, Maintenance, Logistics","Medium","₹4L–₹12L",7,10],
  ...
  ["Retail, Commerce & Marketplaces",[
    ...
    ["Multi-location Franchise Management","Retail, F&B, Education","Enterprise","₹8L–₹20L",14,18],
  ]],
  ...
  ["Niche & Community Platforms",[
    ...
    ["Job Portal / Career Site","HR & Staffing, Recruitment Marketplaces","High","₹5L–₹14L",9,13],
  ...
  ["Enterprise & Bespoke Builds",[
    ["ERP – Enterprise Resource Planning","Manufacturing, Enterprise","Enterprise","₹15L–₹60L",20,32],
    ["Custom Enterprise Platform","Enterprise","Enterprise","₹15L–₹60L",20,32],
    ["Custom Business Software","All Businesses","High","₹8L–₹25L",12,20],
    ["AI Automation Platform (Enterprise-grade)","Enterprise, SaaS","Enterprise","₹8L–₹25L",12,18],
  ]],
];
...
function complexityStyle(complexity) {
  ...
  const font = (complexity === 'Enterprise' || complexity === 'High')
    ? COMPLEXITY_FONT_LIGHT : COMPLEXITY_FONT_DARK;
...
const SLA_BY_TIER = { Basic: '3 business days', Medium: '2 business days', High: '1 business day', Enterprise: 'Same-day (priority)' };
...
function addColumnHeaders(ws, headers) {
  ...
  r.eachCell(cell => {
    ...
    cell.border = { bottom: { style: 'medium', color: { argb: BRAND_PINK } }, right: { style: 'thin', color: { argb: BORDER_COLOR } } };
  });
  r.height = 22;
  return r;
}
...
function addDataRows(ws, rows, isEven = false) {
  rows.forEach((r, i) => {
    ...
    const rowData = [
      name, industries, complexity,
      marketPrice, `${wkMin}–${wkMax} wks`, maint,
    ...
    row.eachCell((cell, colIdx) => {
      cell.fill = bg;
      cell.alignment = { vertical: 'middle', wrapText: true };
      cell.border = { bottom: { style: 'thin', color: { argb: BORDER_COLOR } }, right: { style: 'thin', color: { argb: BORDER_COLOR } } };
      cell.font = { size: 10 };
    });
...
// ── SHEET 1: Website ─────────────────────────────────────────────────────────
{
  ...
  addColumnHeaders(ws, MAIN_COLS.map(c => c.header));
...
// ── SHEET 5: Maintenance ──────────────────────────────────────────────────────
{
  ...
  const CARE_BY_TIER = { Basic: 'Basic Care', Medium: 'Standard Care', High: 'Premium Care', Enterprise: 'Premium Care' };
  const SLA_MAP = { Basic: '3 business days', Medium: '2 business days', High: '1 business day', Enterprise: 'Same-day (priority)' };
  ...
  function addMaintSection(title, rows) {
    ...
    const colHdr = ws.addRow(['Category / Service','Complexity','Recommended Tier','Market Maint / yr','Market SLA','ORVION Maint / yr','ORVION SLA']);
    ...
    rows.forEach((r, i) => {
      const bg = i % 2 === 0
        ...
        : { type: 'pattern', pattern: 'solid', fgColor: { argb: MUTED_BG } };
      const row = ws.addRow([
        r[0], r[2], CARE_BY_TIER[r[2]],
        maintRange(r[3]), SLA_MAP[r[2]],
        '— fill in —', '— fill in —'
      ]);
      row.eachCell(cell => { cell.fill = bg; cell.alignment = { vertical: 'middle', wrapText: true }; cell.font = { size: 10 }; });
      Object.assign(row.getCell(2), complexityStyle(r[2]));
      row.getCell(2).alignment = { vertical: 'middle', horizontal: 'center' };
      [6, 7].forEach(ci => { row.getCell(ci).fill = BLANK_FILL; row.getCell(ci).font = { color: { argb: 'FFCCBBAA' }, italic: true, size: 9 }; });
      row.height = 18;
    });
  }
...
// ── SHEET 6: Add-ons ─────────────────────────────────────────────────────────
{
  ...
  ADDONS.forEach((addon, i) => {
    ...
    row.eachCell(cell => { cell.fill = bg; cell.alignment = { vertical: 'middle' }; cell.font = { size: 10 }; });
